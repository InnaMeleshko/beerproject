  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ fontWeight: "300", color: "#4e342e" }}
      >
        ...
        <p>
          {" "}
          It was built to understand how to use props to create reusable and
          composable react components, how to work with state and hooks
        </p>
